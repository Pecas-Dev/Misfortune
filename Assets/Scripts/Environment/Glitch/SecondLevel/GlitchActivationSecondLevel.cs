...
public class GlitchActivationSecondLevel : MonoBehaviour
{
    CharacterMove characterScript;

    [SerializeField] CameraShakeSecondLevel cameraShakeScriptSecondLevel;
    ...
    void OnTriggerStay2D(Collider2D other)
    {
        if (other.tag == "Player")
        {
            ...
            CameraShakeSecondLevel.Instance.CameraShakeGradualIncrease(cameraShakeIntensity / distance.magnitude);
        }
    }
    ...
    void OnTriggerExit2D(Collider2D collision)
    {
        if (collision.tag == "Player")
        {
            ...
            CameraShakeSecondLevel.Instance.CameraShakeGradualIncrease(0.0f);
